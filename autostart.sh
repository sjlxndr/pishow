...
# Check if the script is running on the main console (/dev/tty1)
# The single command to start the graphical session and run the slideshow script
startx /home/pi/run_slideshow.sh
fi
